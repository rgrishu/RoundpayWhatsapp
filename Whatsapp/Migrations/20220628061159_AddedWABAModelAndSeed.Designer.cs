...
namespace Whatsapp.Migrations
{
    ...
    [Migration("20220628061159_AddedWABAModelAndSeed")]
    partial class AddedWABAModelAndSeed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Whatsapp.Models.Data.WhatsappUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LockoutEnd = new DateTimeOffset(new DateTime(2022, 6, 28, 11, 41, 59, 623, DateTimeKind.Unspecified).AddTicks(8282), new TimeSpan(0, 5, 30, 0, 0)),
                            Name = "Admin",
            ...
            modelBuilder.Entity("Whatsapp.Models.WABAsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
